...
import ContactMapImg from "../../assets/contact_map_img.png";
   ...
   return (
      <div className="contact_section">
         <div className="contact_section_content">
            <div className="contact_location_on" style={{ display: "flex", position: "absolute", left: "13rem", top: "20rem", zIndex: "1", alignSelf: "left" }}>
               <img src={LocationOn} alt="Location on" style={{ objectFit: "contain", height: "70px", width: "70px" }} />
            </div>
            <div className="contact_section_content_img">
               <img src={ContactMapImg} alt="Contact" />
            </div>
            {/* <div className="contact_location_on" style={{ display: "flex", position: "relative", marginLeft: "2rem", zIndex: "3" }}>
            ...
            {/* <div className="contact_location_on" style={{ display: "flex", position: "relative", marginLeft: "0", zIndex: "3" }}>
               <img src={LocationOn} alt="Location on" />
            </div> */}
         </div>
      </div>
